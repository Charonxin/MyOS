...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o $(BUILD_DIR)/timer.o $(BUILD_DIR)/kernel.o \
	 $(BUILD_DIR)/print.o $(BUILD_DIR)/debug.o $(BUILD_DIR)/thread.o
...
$(BUILD_DIR)/thread.o: kernel/thread.c kernel/thread.h lib/stdint.h lib/string.c kernel/global.h kernel/memory.h
	$(CC) $(CFLAGS) $< -o $@
