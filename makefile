...
$(BUILD_DIR)/thread.o: kernel/thread.c kernel/thread.h lib/stdint.h lib/string.c kernel/global.h kernel/memory.h kernel/debug.h kernel/interrupt.h lib/kernel/print.h \
			           lib/kernel/list.h
	$(CC) $(CFLAGS) $< -o $@
