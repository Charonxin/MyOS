 ...
 */
void
list_insert_before (struct list_elem* before, struct list_elem* elem) {
 ...
 */
void
list_push (struct list* list, struct list_elem* elem) {
 ...
 */
void
list_append (struct list* list, struct list_elem* elem) {
 ...
 */
struct list_elem*
list_traversal (struct list* list, function func, int arg) {
  if (list_empty (list)) {
    return NULL;
  }
