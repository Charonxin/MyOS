...
void
bitmap_init (struct bitmap* btmap) {
 ...
 */
int
bitmap_scan_test (struct bitmap* btmap, uint32_t index) {
 ...
 */
int
bitmap_scan (struct bitmap* btmap, uint32_t cnt) {
  uint32_t idx_byte= 0;
...
void
bitmap_set (struct bitmap* btmap, uint32_t index, int8_t value) {
