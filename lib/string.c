 ...
 */
void
memset (void* address, uint8_t value, uint32_t size) {
  ASSERT (address != NULL);
 ...
 */
int
memcmp (const void* left, const void* right, uint32_t size) {
...
char*
strchr (const char* str, const uint8_t c) {
  ASSERT (str != NULL);
 ...
 */
char*
strrchr (const char* str, const uint8_t c) {
  ASSERT (str != NULL);
 ...
 */
uint32_t
strchrs (const char* str, const uint8_t c) {
  ASSERT (str != NULL);
